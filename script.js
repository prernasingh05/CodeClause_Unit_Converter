...
function myResult() {
    ...
    // when u change the input and output value we need to update the InputTypeValue and ResultTypeValue
    InputTypeValue = InputType.value;
    ResultTypeValue = ResultType.value;

    // Now compare the input and output resultType value and add formula
    ...
    // Weight Converter
    // Kilogram to gram,Miligram,Microgram,Pound
    ...
    // Gram to kilogram,miligram,microgram,pound
    ...
    // miligram to kilogram,gram,microgram,pound
